...
#placesList .item .info{padding:10px 0 10px 12px;}
...
#placesList{padding-left: 0 !important;}
</style>
</head>
<body>
<div class="map_wrap">
    <div id="map" style="width:50%;height:100%;position:relative;overflow:hidden;display: none;"></div>
            ...
            <div>
                <form onsubmit="searchPlaces(); return false;">
                 <div style="display: flex; align-items: center;">
                  <input type="text" value="" id="keyword" class="form-control" placeholder="검색어를 입력하세요" style="width: 85%;"> 
        ...
        // mouseout 했을 때는 인포윈도우를 닫습니다
         ...
         (function(marker, title, lat, lng) {
            kakao.maps.event.addListener(marker, 'click', function() {
            	...
            	var lat = marker.getPosition().getLat();//마커의 위도 저장
            	var lng = marker.getPosition().getLng();//마커의 경도 저장
...
function getListItem(index, places) {
    ...
    itemStr = /* '<span class="markerbg marker_' + (index+1) + '"></span>' + */
                '<div class="info" data-bs-dismiss="modal">' +
...
function displayInfowindow(marker, title,lat,lng) {
    var content = '<div style="padding:5px;z-index:1;">' + "제목:"+title +"위도:"+lat+"경도:"+lng+'</div>';
